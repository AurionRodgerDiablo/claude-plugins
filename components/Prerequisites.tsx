...
export function Prerequisites() {
  return (
    <section className="py-16 px-4 bg-blue-50 dark:bg-blue-950/20 border-y border-blue-200 dark:border-blue-900">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-gray-900 dark:bg-black p-6 rounded-lg">
